...
class MoviesReleasedIn2020Spider(scrapy.Spider):
    name = 'movies-released-in-2020'
    allowed_domains = ['www.imdb.com']
    start_urls = [
        'https://www.imdb.com/search/title/?title_type=feature&release_date=2020-01-01,2020-12-31&runtime=1,&sort=release_date,asc&count=250']
    ...
    def parse(self, response):
        ...
        for movie_el in movies_el:
            ...
            try:
                duration = movie_el.css('p:nth-of-type(1) > span.runtime::text').get()
                duration = duration.split(' ')[0]
            except:
                duration = None

            try:
                genres=movie_el.css('p:nth-of-type(1) > span.genre::text').get()
            except:
                genres=None
            ...
            try:
                synopsis=movie_el.css('p:nth-of-type(2)::text').get()
            except:
                synopsis=None
